...
public class BaseRegisterView extends BaseView {
    ...
    /**
     * Creates new form BaseRegisterView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaseRegisterView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaseRegisterView().setVisible(true);
            }
        });
    }
